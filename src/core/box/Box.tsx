...
type CSSProp<T extends keyof JSX.IntrinsicElements | JSXElementConstructor<any>> = PartialBy<Pick<React.ComponentProps<T>, 'css'>, 'css'>;

type ComponentCSSProp = CSSProp<typeof Component>;
type ComponentVariants = StitchesVariants<typeof Component>;
